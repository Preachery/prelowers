...
const I18N = {
    en: {
        badge: 'Now with AI-powered delays',
        heroTitle: 'Master your<br>Instagram<br><span>network</span>',
        heroSub: 'Prelowers is the modern client-side manager built for users that refuse to lose control. Secure unfollowing and ghost removal — all in one script.',
        copyBtn: 'Copy Script',
        learnMore: 'See features',
        badge1: 'Client-side',
        badge2val: 'Real-time',
        badge2lbl: 'API fetching',
        codeReview: 'PRELOWERS CODE REVIEW',
        fTag: 'Platform features',
        fTitle: 'Everything your account needs',
        fSub: 'One script to find non-followers, remove ghost followers, and track your network safely.',
        f1Title: '100% Secure',
        f1Sub: 'Runs entirely in your browser. We never ask for or store your password.',
        f2Title: 'Smart Filtering',
        f2Sub: 'Easily see who doesnt follow you back, or who you aren't following.',
        f3Title: 'Anti-Ban Tech',
        f3Sub: 'Built-in dynamic delays and speed controls keep your account safe from rate-limits.',
        pTitle: 'Ready to use?',
        pSub: 'Copy the script, open Instagram.com, open Developer Tools (F12), and paste the code into the Console tab.',
        toast: 'Script copied to clipboard!'
    },
    tr: {
        badge: 'Yapay Zeka Destekli Bekleme',
        heroTitle: 'Instagram Ağınıza<br>Hükmedin<br><span>hemen</span>',
        heroSub: 'Prelowers, kontrolü kaybetmek istemeyen kullanıcılar için tasarlanmış modern bir istemci aracıdır. Şifresiz güvenli takipten çıkma.',
        copyBtn: 'Kodu Kopyala',
        learnMore: 'Özellikleri gör',
        badge1: 'Tarayıcı İçi',
        badge2val: 'Anlık',
        badge2lbl: 'API Verisi',
        codeReview: 'PRELOWERS KOD İNCELEME',
        fTag: 'Platform özellikleri',
        fTitle: 'Hesabınızın ihtiyacı olan her şey',
        fSub: 'Sizi takip etmeyenleri bulun, sahte takipçileri silin ve ağınızı güvenle yönetin.',
        f1Title: '%100 Güvenli',
        f1Sub: 'Tamamen tarayıcınızda çalışır. Şifrenizi asla sormayız veya kaydetmeyiz.',
        f2Title: 'Akıllı Filtreleme',
        f2Sub: 'Sizi geri takip etmeyenleri kolayca listele ve seçerek takipten çık.',
        f3Title: 'Ban Karşıtı Sistem',
        f3Sub: 'Dahili dinamik beklemeler ve hız ayarları ile hesabınızı limitlerden korur.',
        pTitle: 'Kullanıma hazır mısın?',
        pSub: 'Kodu kopyalayın, Instagram.com'u açın, Geliştirici Araçlarını (F12) açıp kodu Console sekmesine yapıştırın.',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('./tool.js').then(r => r.text()).then(data => {
        scriptContent = data;
        if(codeViewer) {
